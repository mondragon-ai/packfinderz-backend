## **Title [PF-1001]: Create `notifications` table and indexes**
...
* Blocked by: None
* Blocks: PF-1002, PF-1003, PF-1006
...
## **Title [PF-1002]: Implement notifications repository and service layer**
...
* Blocked by: PF-1001
* Blocks: PF-1003, PF-1004, PF-1005
...
## **Title [PF-1003]: List in-app notifications endpoint**
...
## **Title [PF-1004]: Mark single notification as read**
...
## **Title [PF-1005]: Mark all notifications as read**
...
## **Title [PF-1006]: Notification TTL cleanup scheduler**
