...
Implement the license creation endpoint that **atomically creates license metadata and binds it to an existing media object**. Creating a license without a media reference MUST be impossible.
...
* Validation: media must be `uploaded|ready`
