...
## **[PF-XXX] Repository: Buyer Orders List (Paginated + Filtered)**
...
* [ ] Includes totals, payment status, fulfillment status, vendor summary
...
## **[PF-XXX] Repository: Vendor Orders List (Paginated + Filtered)**
...
* Filters: status, date range, “needs action”
* Cursor pagination
...
## **[PF-XXX] Repository: Order Detail with Preloads**
...
* [ ] Includes active agent assignment if present
...
## **[PF-XXX] Controllers: Order List + Order Detail APIs**
...
## **[PF-XXX] Vendor Order-Level Decision Service**
...
## **[PF-XXX] Vendor Line-Item Decision + Balance Recompute**
...
Allow vendors to accept/reject individual line items, recompute order totals, release inventory, and update fulfillment state.
...
* [ ] Accept/reject per line item
* [ ] Recompute `balance_due_cents`
* [ ] Release inventory for rejected items
* [ ] Update order status correctly
* [ ] Emit `order_decided` outbox with line-level detail
...
## **[PF-XXX] Fulfillment Transition + Dispatch Readiness**
