...
* Blocked by: None
* Blocks: PF-302, PF-305, PF-306, PF-308, PF-310
...
# [INCOMPLETE ❌] Title [PF-XXX]: Persist Square customer identifiers on Store
...
# [INCOMPLETE ❌] Title [PF-XXX]: Refactor subscriptions persistence to enforce 0..1 subscription per store
...
* [ ] Database enforces one subscription per store
* [ ] Subscription model includes required linkage fields
* [ ] Existing subscription rows remain valid
...
# [INCOMPLETE ❌] Title [PF-XXX]: Implement Square customer creation and registration integration
...
* [ ] Register flow creates or reuses Square customer idempotently
* [ ] `square_customer_id` is persisted on store
* [ ] Partial failures leave store in consistent state

## Dependencies

* Blocked by: PF-301, PF-303
* Blocks: PF-306, PF-309
...
# [INCOMPLETE ❌] Title [PF-XXX]: Implement card-on-file flow (Square Web Payments SDK → backend)
...
* Blocked by: PF-301, PF-305
* Blocks: PF-309, PF-312
...
# [INCOMPLETE ❌] Title [PF-XXX]: Add billing_plans table, model, and repository
...
# [INCOMPLETE ❌] Title [PF-XXX]: Implement BillingPlan admin and vendor APIs
...
* [ ] Admin can manage billing plans
* [ ] Vendors can list and view active plans only
...
# [INCOMPLETE ❌] Title [PF-XXX]: Implement vendor subscription lifecycle endpoints
...
Implement vendor-facing subscription lifecycle endpoints using stored Square customer, card, and billing plan mapping. Ensure persistence and store subscription state remain aligned.
...
* Blocked by: PF-302, PF-304, PF-306, PF-308
* Blocks: PF-310

## Technical Notes

* Relevant: `internal/subscriptions.Service`
...
# [INCOMPLETE ❌] Title [PF-XXX]: Harden Square webhook reconciliation for subscriptions
...
# [INCOMPLETE ❌] Title [PF-XXX]: Implement ad usage charges persistence and listing
...
* Persist ad usage billing outcomes into `usage_charges`
...
# [INCOMPLETE ❌] Title [PF-XXX]: Implement nightly ad usage billing worker
...
# [INCOMPLETE ❌] Title [PF-XXX]: Add billing permissions, guards, and PII redaction enforcement
