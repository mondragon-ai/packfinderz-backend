...
## **Title [PF-111]: Analytics ingestion consumers (outbox → BigQuery)**
...
## **Title [PF-112]: Vendor analytics API endpoint**
...
* Support custom ranges as well (start & end timestamps)
* Return:
