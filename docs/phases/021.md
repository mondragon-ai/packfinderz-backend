...
# Title [PF-XXX]: Implement marketplace_events row mapping for order_created payload [INCOMPLETE ❌]
...
# Title [PF-XXX]: Implement attribution token decoding and ad conversion record generation [INCOMPLETE ❌]
...
# Title [PF-XXX]: Implement marketplace_events handling for order_paid and cash_collected events [INCOMPLETE ❌]
...
# Title [PF-XXX]: Implement marketplace_events handling for order_canceled and order_expired events [INCOMPLETE ❌]
...
# Title [PF-XXX]: Emit ad_daily_charge_recorded analytics events from nightly billing job and write charge rows to ad_event_facts [INCOMPLETE ❌]
...
# Title [PF-XXX]: Implement Marketplace Analytics query service using BigQuery SQL [INCOMPLETE ❌]
...
# Title [PF-XXX]: Implement Ad Analytics query service using BigQuery SQL [INCOMPLETE ❌]
...
# Title [PF-XXX]: Add marketplace analytics API endpoints backed by BigQuery query service [INCOMPLETE ❌]
...
# Title [PF-XXX]: Add ad analytics API endpoints backed by BigQuery query service [INCOMPLETE ❌]
...
# Title [PF-XXX]: Build analytics ingestion and query test harness plus one-time BigQuery backfill script [INCOMPLETE ❌]
