...
## **PF-091 — Checkout Domain Helpers (Validation + Grouping + Totals)**
...
## **PF-092 — Atomic Inventory Reservation Helper**
...
## **PF-093 — Checkout Orchestrator Service (Core Logic)**
...
## **PF-094 — Checkout Idempotency Enforcement**
...
## **PF-095 — Emit `order_created` Outbox Event**
...
## **PF-096 — Checkout Submission Endpoint (`POST /api/v1/checkout`)**
