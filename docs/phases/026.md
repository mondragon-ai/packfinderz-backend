...
# Title [INCOMPLETE ❌] [PF-237]: Emit Notifications outbox event for checkout conversion
...
# Title [INCOMPLETE ❌] [PF-XXX]: Emit Analytics outbox event for checkout conversion with attribution
