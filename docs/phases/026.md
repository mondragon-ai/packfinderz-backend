# Title [INCOMPLETE ❌] [PF-233]: Create one payment_intent per vendor order inside checkout transaction
...
# Title [INCOMPLETE ❌] [PF-234]: Set payment intent amount and payment method from checkout confirmation
